...
using System;
using neo_raknet.Packet; // 假设基础 Packet 类在此命名空间或需相应调整
...
{/// <summary>
    ...
    public class McpeEducationResourceURI : Packet
    {
        ...
        /// Resource 是正在被引用的资源。
        /// </summary>
        public EducationSharedResourceURI Resource { get; set; } = new EducationSharedResourceURI();
        ...
        protected override void DecodePacket()
        {
            ...
            string buttonName = ReadString();

            // 读取 Resource.LinkURI (string)
            string linkUri = ReadString();
