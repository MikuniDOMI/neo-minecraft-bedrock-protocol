...
public class McpeEducationSettings : Packet
{
    ...
    /// <summary>
    /// The default URI that the Code Builder is ran on. Using this, a Code Builder program can make code directly affect the server.
    /// </summary>
    ...
    /// </summary>
    public Optional<string> OverrideURI { get; set; } = new Optional<string>();
    ...
    /// </summary>
    public Optional<EducationExternalLinkSettings> ExternalLinkSettings { get; set; } = new Optional<EducationExternalLinkSettings>();
    ...
    protected override void EncodePacket()
    {
        ...
        if (CanModifyBlocks.HasValue)
        {
            Write(CanModifyBlocks.Value);
        }

        // Optional<string> - OverrideURI
        Write(OverrideURI.HasValue);
        if (OverrideURI.HasValue)
        {
            Write(OverrideURI.Value);
        }
    ...
    protected override void DecodePacket()
    {
        ...
        if (CanModifyBlocks.HasValue)
        {
            CanModifyBlocks.Value = ReadBool();
        }
