...
public class NbtIntConverter : JsonConverter
{
    public override bool CanConvert(Type objectType)
    {
        return objectType == typeof(NbtLong) || objectType == typeof(NbtInt) || objectType == typeof(NbtShort) ||
               objectType == typeof(NbtByte) || objectType == typeof(NbtByteArray) || objectType == typeof(NbtFloat);
    }
